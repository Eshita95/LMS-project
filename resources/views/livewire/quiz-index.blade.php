        ...
        <table class="w-full border">
            <thead>
                <tr class="bg-gray-50 border-b">
                    <th class="p-2 border-r cursor-pointer"> Name
    </div>
    </th>
        ...
        @foreach ($quizzes as $quiz)
            <tr class="bg-gray-100 text-center border-b ">
                ...
                <td class="flex items-center justify-center">
                    ...
                    <form wire:submit.prevent="deleteQuiz({{ $quiz->id }})"><button
                        class="ml-2  pt-2" onclick="return confirm('Are you sure?');" type="submit"> @include('components.icons.trash')
                        </button>
                    </form>
